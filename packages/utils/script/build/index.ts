...
export const buildTotalStyle = () => {
  return src(`${componentPath}/styles/**.less`)
    .pipe(less())
    .pipe(autoprefixer())
    .pipe(dest(`${componentPath}/dist/lib/packages/components/styles`))
    .pipe(dest(`${componentPath}/dist/es/packages/components/styles`))
...
export const buildStyle = () => {
  return src(`${componentPath}/src/**/styles/**.less`)
    .pipe(less())
    .pipe(autoprefixer())
    .pipe(dest(`${componentPath}/dist/lib/packages/components/src`))
    .pipe(dest(`${componentPath}/dist/es/packages/components/src`))
